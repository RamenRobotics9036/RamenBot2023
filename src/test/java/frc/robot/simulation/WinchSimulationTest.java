...
public class WinchSimulationTest {
  ...
  public void nullDcMotorSimShouldThrowException() {
    assertThrows(IllegalArgumentException.class, () -> {
      WinchSimModel tempWinchSimulation = new WinchSimModel(null, m_spoolDiameterMeters,
  ...
  public void initialLenSpooledLessThanTotalStringLenShouldSucceed() {
    WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters, 5,
        4, m_initialStringOrientation, m_invertMotor);
  ...
  public void initialLenSpooledLenEqualToTotalStringLenShouldSucceed() {
    WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters, 5,
        5, m_initialStringOrientation, m_invertMotor);
  ...
  public void initialLenSpooledLenGreaterThanTotalStringLenShouldFail() {
    assertThrows(IllegalArgumentException.class, () -> {
      WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters,
          5, 5.1, m_initialStringOrientation, m_invertMotor);
      assertTrue(tempWinchSimulation != null);
    });
  }
  ...
  public void initialLenSpooledLenZeroShouldSucceed() {
    WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters, 5,
        0, m_initialStringOrientation, m_invertMotor);
  ...
  public void initialLenSpooledLenLessThanZeroShouldFail() {
    assertThrows(IllegalArgumentException.class, () -> {
      WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters,
          5, -1, m_initialStringOrientation, m_invertMotor);
      assertTrue(tempWinchSimulation != null);
    });
  }
  ...
  public void queryingStringLenExtendedShouldReturnCorrectValueWhenStringOnBack() {
    ...
    WinchSimModel tempWinchSimulation = new WinchSimModel(m_relEncoderSim, m_spoolDiameterMeters,
        totalStringLen, stringLenSpooled, stringOrientation, m_invertMotor);
